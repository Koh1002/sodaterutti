...
export function getPlaceholderSvg(label: string, size: number = 256): string {
  const colors: Record<string, string> = {
    baby_boy: '#B5C7D3',
    baby_girl: '#D5B5BC',
    baby_fuwacchi: '#F5EDE0',
    baby_kiracchi: '#F5E6A0',
    kids_marucchi: '#E3D5CA',
    kids_kuchitamacchi: '#D5C4A0',
    kids_mohitamacchi: '#B9BAA3',
    kids_mizutamacchi: '#C5B5C8',
    kids_hoshitamacchi: '#D5C4A0',
    kids_hanatamacchi: '#E8B5C0',
    kids_yukitamacchi: '#D5E5F0',
    kids_hinatamacchi: '#F0C890',
    ...
    young_honacchi: '#E8C5D0',
    young_yukicchi: '#C5D8E8',
    young_hinacchi: '#E8A860',
    young_kiracchi: '#E8D5A0',
